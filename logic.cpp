            ...
            for(int i=0;i<250;i++)
            {
                if(obc[j].first==applicants[i].user_id)
                {
                    if(applicants[i].is_allocated==false)
                    {
                        ...
                        {
                            giveSeat(applicants[i].college_choice_1,applicants[i].branch_choice_1,applicants[i].category);
                        ...
                        {
                            giveSeat(applicants[i].college_choice_2,applicants[i].branch_choice_2,applicants[i].category);
                        ...
                        {
                            giveSeat(applicants[i].college_choice_3,applicants[i].branch_choice_3,applicants[i].category);
            ...
            for(int i=0;i<250;i++)
            {
                if(open[j].first==applicants[i].user_id)
                {
                    if(applicants[i].is_allocated==false)
                    {
                        ...
                        {
                            giveOpenSeat(applicants[i].college_choice_1,applicants[i].branch_choice_1);
                            applicants[i].allocated_branch=applicants[i].branch_choice_1;
                            break;
                        }
                        else if(checkOpenSeat(applicants[i].college_choice_2,applicants[i].branch_choice_2))
                        {
                            giveOpenSeat(applicants[i].college_choice_2,applicants[i].branch_choice_2);
                            applicants[i].allocated_branch=applicants[i].branch_choice_2;
                            break;
                        }
                        else if(checkOpenSeat(applicants[i].college_choice_3,applicants[i].branch_choice_3))
                        {
                            giveOpenSeat(applicants[i].college_choice_3,applicants[i].branch_choice_3);
                            applicants[i].allocated_branch=applicants[i].branch_choice_3;
                            break;
                        }
                    }
